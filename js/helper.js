...
var HTMLschoolDegree = '<div class="other-text"> -- %data%</a>';
...
var HTMLonlineSchool = '<div class="other-text"> - %data%</div>';
  ...
  */
  function locationFinder() {
    ...
    for (var job in work.positions) {
      locations.push(work.positions[job].city);
    }
